...
CREATE TABLE "departments" ("id" integer primary key, "name" text not null, "creationDate" datetime not null, "modificationDate" datetime not null);

CREATE TABLE "employees" ("id" integer primary key, "active" integer not null, "firstName" text not null, "lastName" text not null, "hireDate" datetime, "phone" text, "address" text, "avatarUrl" text, "creationDate" datetime not null, "modificationDate" datetime not null, "departmentId" integer references "department" ("id") on delete NO ACTION);
...
INSERT INTO "departments" ("id","name","creationDate","modificationDate") VALUES (1,'Human Resources','2024-08-27 04:10:52','2024-08-27 04:10:52'),
...
INSERT INTO "employees" ("id","active","firstName","lastName","hireDate","phone","address","avatarUrl","creationDate","modificationDate","departmentId") VALUES (1,1,'Dale','Cooper','1990-01-21','911','Twin Peaks','https://upload.wikimedia.org/wikipedia/en/5/50/Agentdalecooper.jpg','2024-08-27 04:10:52','2024-08-27 04:10:52',NULL),
